...
<div class="hero">
  <div style="display:flex; align-items:center; justify-content:center; gap:10px; margin-bottom:8px;">
    <div class="sb-logo" style="width:40px;height:40px;border-radius:14px;background:transparent;box-shadow:none;"><img src="data:image/png;base64,{LOGO_PNG_B64}" style="width:40px;height:40px;object-fit:contain;border-radius:14px;" /></div>
...
<div class="sb-logo" style="background:transparent; box-shadow:none;"><img src="data:image/png;base64,{LOGO_PNG_B64}" style="width:34px;height:34px;object-fit:contain;border-radius:10px;" /></div>
<div>
